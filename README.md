...
### Deliverables
<!-- * (DONE) Populate page with quotes with a `GET` request to `http://localhost:3000/quotes`. -->

<!-- * (DONE) Each quotes should have the following structure:
  ```
    <li class='quote-card'>
  ...
  ```
<!-- (DONE) Submitting the form creates a new quote and adds it to the list of quotes without having to refresh the page. (Whether you choose to optimistically render or not is up to you). -->
